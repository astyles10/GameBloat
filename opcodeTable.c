...
#define SOURCE_IMPLIED NULL
#define DEST_IMPLIED NULL
...
const struct opcode baseOpcodeTable[256] = {
    ...
    { "LD (BC),A", { eDestShort, eSrcChar, (uPointerType)&registers.BC, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_dd_A },           // 0x02
    ...
    { "ADD HL,HL", { eDestNone, eSrcShort, DEST_IMPLIED, (uPointerType)&registers.HL, noCondition }, eNoOperands, add_HL_ss },      // 0x29
    { "LDI A,(HL)", { eDestNone, eSrcNone, DEST_IMPLIED, SOURCE_IMPLIED, noCondition }, eNoOperands, ldi_A_mHL },                   // 0x2A
    ...
    { "CPL", { eDestNone, eSrcNone, DEST_IMPLIED, NO_SOURCE}, eNoOperands, cpl },                                                   // 0x2F
    ...
    { "LDD (HL),A", { eDestNone, eSrcNone, DEST_IMPLIED, SOURCE_IMPLIED, noCondition}, eNoOperands, ldd_mHL_A },                    // 0x32
    { "INC SP", { eDestShort, eSrcNone, (uPointerType)&registers.SP, NO_SOURCE, noCondition }, eNoOperands, inc_ss },               // 0x33
    { "INC (HL)", { eDestNone, eSrcNone, DEST_IMPLIED, SOURCE_IMPLIED, noCondition }, eOperandMemAddr, inc_mHL },                   // 0x34
    { "DEC (HL)", { eDestNone, eSrcNone, DEST_IMPLIED, SOURCE_IMPLIED, noCondition }, eOperandMemAddr, dec_mHL },         // 0x35
    { "LD (HL),n", { eDestNone, eSrcChar, DEST_IMPLIED, SOURCE_IMMEDIATE, noCondition }, eOperandShort, ld_mHL_n },                 // 0x36
    ...
    { "ADD HL,SP", { eDestNone, eSrcShort, DEST_IMPLIED, (uPointerType)&registers.SP, noCondition }, eNoOperands, add_HL_ss },      // 0x39
    { "LDD A,(HL)", { eDestNone, eSrcShort, DEST_IMPLIED, SOURCE_IMPLIED, noCondition }, eNoOperands, ldd_A_mHL },                  // 0x3A
    ...
    { "LD B,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.B, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x46
    ...
    { "LD C,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.C, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x4E
    ...
    { "LD D,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.D, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x56
    ...
    { "LD E,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.E, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x5E
    ...
    { "LD H,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.H, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x66
    ...
    { "LD L,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.L, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x6E
    { "LD L,A", { eDestChar, eSrcChar, (uPointerType)&registers.L, (uPointerType)&registers.A, noCondition }, eNoOperands, ld_d_r },// 0x6F

    { "LD (HL),B", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.B, noCondition }, eNoOperands, ld_mHL_r },         // 0x70
    { "LD (HL),C", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.C, noCondition }, eNoOperands, ld_mHL_r },         // 0x71
    { "LD (HL),D", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.D, noCondition }, eNoOperands, ld_mHL_r },         // 0x72
    { "LD (HL),E", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.E, noCondition }, eNoOperands, ld_mHL_r },         // 0x73
    { "LD (HL),H", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.H, noCondition }, eNoOperands, ld_mHL_r },         // 0x74
    { "LD (HL),L", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.L, noCondition }, eNoOperands, ld_mHL_r },         // 0x75
    { "HALT", { eDestNone, eSrcNone, NO_DEST, NO_SOURCE, noCondition }, eNoOperands, halt },                                        // 0x76
    { "LD (HL),A", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.A, noCondition }, eNoOperands, ld_mHL_r },         // 0x77
    ...
    { "LD A,(HL)", { eDestChar, eSrcShort, (uPointerType)&registers.A, SOURCE_IMPLIED, noCondition }, eNoOperands, ld_d_mHL },      // 0x7E
    { "LD A,A", { eDestChar, eSrcChar, (uPointerType)&registers.A, (uPointerType)&registers.A, noCondition }, eNoOperands, ld_d_r },// 0x7F

    { "ADD A,B", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.B, noCondition }, eNoOperands, add_s },              // 0x80
    { "ADD A,C", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.C, noCondition }, eNoOperands, add_s },              // 0x81
    { "ADD A,D", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.D, noCondition }, eNoOperands, add_s },              // 0x82
    { "ADD A,E", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.E, noCondition }, eNoOperands, add_s },              // 0x83
    { "ADD A,H", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.B, noCondition }, eNoOperands, add_s },              // 0x84
    { "ADD A,L", { eDestNone, eSrcChar, DEST_IMPLIED, (uPointerType)&registers.B, noCondition }, eNoOperands, add_s },              // 0x85
    { "ADD A,(HL)", { eDestNone, eSrcChar, DEST_IMPLIED, SOURCE_IMPLIED, noCondition }, eOperandMemAddr, add_s },                   // 0x86
};
