...
void ld_BC_nn(unsigned short immediate) { ld_dd_nn(&registers.BC, immediate); }

void ld_mBC_A(void) { ld_dd_A(registers.BC); }

void inc_BC(void) { inc_ss(&registers.BC); }

void inc_B(void) { inc_s(&registers.B); }

void dec_B(void) { dec_s(&registers.B); }

void ld_B_n(unsigned char immediate) { ld_r_s(&registers.B, immediate); }

void add_HL_BC(void) { add_HL_ss(registers.BC); }

void ld_A_mBC(void) { ld_A_ss(registers.BC); }

void dec_BC(void) { dec_ss(&registers.BC); }

void inc_C(void) { inc_s(&registers.C); }

void dec_C(void) { dec_s(&registers.C); }

void ld_C_n(unsigned char immediate) { ld_r_s(&registers.C, immediate); }

void ld_DE_nn(unsigned short immediate) { ld_dd_nn(&registers.DE, immediate); }

void ld_mDE_A(void) { ld_dd_A(registers.DE); }

void inc_DE(void) { inc_ss(&registers.DE); }

void inc_D(void) { inc_s(&registers.D); }

void dec_D(void) { dec_s(&registers.D); }

void ld_D_n(unsigned char immediate) { ld_r_s(&registers.D, immediate); }
...
void inc_E(void) { inc_s(&registers.E); }

void dec_E(void) { inc_s(&registers.E); }

void ld_E_n(unsigned char immediate) { ld_r_s(&registers.E, immediate); }

void jr_NZ_n(unsigned char immediate) {
  jr_cc_e(immediate, flagZero, FLAG_NOT_SET);
}

void ld_HL_nn(unsigned short immediate) { ld_dd_nn(&registers.HL, immediate); }

void inc_HL(void) { inc_ss(&registers.HL); }

void inc_H(void) { inc_s(&registers.H); }

void dec_H(void) { dec_s(&registers.H); }

void ld_H_n(unsigned char immediate) { ld_r_s(&registers.H, immediate); }

void jr_Z_n(unsigned char immediate) { jr_cc_e(immediate, flagZero, FLAG_SET); }

void add_HL_HL(void) { add_HL_ss(registers.HL); }

void dec_HL(void) { dec_ss(&registers.HL); }

void inc_L(void) { inc_s(&registers.L); }

void dec_L(void) { dec_s(&registers.L); }

void ld_L_n(unsigned char immediate) { ld_r_s(&registers.L, immediate); }

void jr_NC_n(unsigned char immediate) {
  jr_cc_e(immediate, flagCarry, FLAG_NOT_SET);
}

void ld_SP_nn(unsigned short immediate) { ld_dd_nn(&registers.SP, immediate); }

void inc_SP(void) { inc_ss(&registers.SP); }

void inc_mHL(void) { inc_sHL(); }

void dec_mHL(void) { dec_sHL(); }

void jr_C_n(unsigned char immediate) {
  jr_cc_e(immediate, flagCarry, FLAG_SET);
}

void add_HL_SP(void) { add_HL_ss(registers.SP); }

void dec_SP(void) { dec_ss(&registers.SP); }

void inc_A(void) { inc_s(&registers.A); }

void dec_A(void) { dec_s(&registers.A); }

void ld_A_n(unsigned char immediate) { ld_r_s(&registers.A, immediate); }

void ld_B_B(void) { ld_r_s(&registers.B, registers.B); }

void ld_B_C(void) { ld_r_s(&registers.B, registers.C); }
void ld_B_D(void) { ld_r_s(&registers.B, registers.D); }
void ld_B_E(void) { ld_r_s(&registers.B, registers.E); }

void ld_B_H(void) { ld_r_s(&registers.B, registers.H); }
...
void ld_C_B(void) { ld_r_s(&registers.C, registers.B); }

void ld_C_C(void) { ld_r_s(&registers.C, registers.C); }

void ld_C_D(void) { ld_r_s(&registers.C, registers.D); }

void ld_C_E(void) { ld_r_s(&registers.C, registers.E); }

void ld_C_H(void) { ld_r_s(&registers.C, registers.H); }
...
void ld_D_B(void) { ld_r_s(&registers.D, registers.B); }

void ld_D_C(void) { ld_r_s(&registers.D, registers.C); }

void ld_D_D(void) { ld_r_s(&registers.D, registers.D); }

void ld_D_E(void) { ld_r_s(&registers.D, registers.E); }

void ld_D_H(void) { ld_r_s(&registers.D, registers.H); }
...
void ld_E_B(void) { ld_r_s(&registers.E, registers.B); }

void ld_E_C(void) { ld_r_s(&registers.E, registers.C); }

void ld_E_D(void) { ld_r_s(&registers.E, registers.D); }

void ld_E_E(void) { ld_r_s(&registers.E, registers.E); }

void ld_E_H(void) { ld_r_s(&registers.E, registers.H); }
...
void ld_H_B(void) { ld_r_s(&registers.H, registers.B); }

void ld_H_C(void) { ld_r_s(&registers.H, registers.C); }

void ld_H_D(void) { ld_r_s(&registers.H, registers.D); }

void ld_H_E(void) { ld_r_s(&registers.H, registers.E); }

void ld_H_H(void) { ld_r_s(&registers.H, registers.H); }
...
void ld_L_B(void) { ld_r_s(&registers.L, registers.B); }

void ld_L_C(void) { ld_r_s(&registers.L, registers.C); }

void ld_L_D(void) { ld_r_s(&registers.L, registers.D); }

void ld_L_E(void) { ld_r_s(&registers.L, registers.E); }

void ld_L_H(void) { ld_r_s(&registers.L, registers.H); }
...
void ld_mHL_B(void) { ld_d_r(registers.B); }

void ld_mHL_C(void) { ld_d_r(registers.C); }

void ld_mHL_D(void) { ld_d_r(registers.D); }

void ld_mHL_E(void) { ld_d_r(registers.E); }

void ld_mHL_H(void) { ld_d_r(registers.H); }

void ld_mHL_L(void) { ld_d_r(registers.L); }

void ld_mHL_A(void) { ld_d_r(registers.A); }

void ld_A_B(void) { ld_r_s(&registers.A, registers.B); }

void ld_A_C(void) { ld_r_s(&registers.A, registers.C); }

void ld_A_D(void) { ld_r_s(&registers.A, registers.D); }

void ld_A_E(void) { ld_r_s(&registers.A, registers.E); }

void ld_A_H(void) { ld_r_s(&registers.A, registers.H); }
...
void add_A_B(void) { add_s(registers.B); }

void add_A_C(void) { add_s(registers.C); }

void add_A_D(void) { add_s(registers.D); }

void add_A_E(void) { add_s(registers.E); }

void add_A_H(void) { add_s(registers.H); }
...
void adc_A_B(void) { adc_s(registers.B); }

void adc_A_C(void) { adc_s(registers.C); }

void adc_A_D(void) { adc_s(registers.D); }

void adc_A_E(void) { adc_s(registers.E); }

void adc_A_H(void) { adc_s(registers.H); }
...
void sub_A_B(void) { sub_s(registers.B); }

void sub_A_C(void) { sub_s(registers.C); }

void sub_A_D(void) { sub_s(registers.D); }

void sub_A_E(void) { sub_s(registers.E); }

void sub_A_H(void) { sub_s(registers.H); }
...
void sbc_A_B(void) { sbc_s(registers.B); }

void sbc_A_C(void) { sbc_s(registers.C); }

void sbc_A_D(void) { sbc_s(registers.D); }

void sbc_A_E(void) { sbc_s(registers.E); }

void sbc_A_H(void) { sbc_s(registers.H); }
...
void and_B(void) { and_s(registers.B); }

void and_C(void) { and_s(registers.C); }

void and_D(void) { and_s(registers.D); }

void and_E(void) { and_s(registers.E); }

void and_H(void) { and_s(registers.H); }
...
void xor_B(void) { xor_s(registers.B); }

void xor_C(void) { xor_s(registers.C); }

void xor_D(void) { xor_s(registers.D); }

void xor_E(void) { xor_s(registers.E); }

void xor_H(void) { xor_s(registers.H); }
...
void or_B(void) { or_s(registers.B); }

void or_C(void) { or_s(registers.C); }

void or_D(void) { or_s(registers.D); }

void or_E(void) { or_s(registers.E); }

void or_H(void) { or_s(registers.H); }
...
void cmp_B(void) { cmp_s(registers.B); }

void cmp_C(void) { cmp_s(registers.C); }

void cmp_D(void) { cmp_s(registers.D); }

void cmp_E(void) { cmp_s(registers.E); }

void cmp_H(void) { cmp_s(registers.H); }
...
void ret_NZ(void) { ret_cc(flagZero, FLAG_NOT_SET); }

void pop_BC(void) { pop_dd(&registers.BC); }
...
void push_BC(void) { push_ss(registers.BC); }

void add_A_n(unsigned char immediate) { add_s(immediate); }

void rst_0(void) { rst_f(0x00); }

void ret_Z(void) { ret_cc(flagZero, FLAG_SET); }
...
void adc_A_n(unsigned char immediate) { adc_s(immediate); }

void rst_08(void) { rst_f(0x08); }

void ret_NC(void) { ret_cc(flagCarry, FLAG_NOT_SET); }

void pop_DE(void) { pop_dd(&registers.DE); }
...
void push_DE(void) { push_ss(registers.DE); }

void sub_A_n(unsigned char immediate) { sub_s(immediate); }

void rst_10(void) { rst_f(0x10); }

void ret_C(void) { ret_cc(flagCarry, FLAG_SET); }
...
void sbc_A_n(unsigned char immediate) { sbc_s(immediate); }

void rst_18(void) { rst_f(0x18); }

void pop_HL(void) { pop_dd(&registers.HL); }

void ldh_mC_A(void) { ldh_n_A(registers.C); }

void push_HL(void) { push_ss(registers.HL); }

void and_n(unsigned char immediate) { and_s(immediate); }
...
void ld_nn_A(unsigned short immediate) { ld_dd_A(immediate); }

void xor_n(unsigned char immediate) { xor_s(immediate); }

void rst_28(void) { rst_f(0x28); }

void pop_AF(void) { pop_dd(&registers.AF); }

void push_AF(void) { push_ss(registers.AF); }

void or_n(unsigned char immediate) { or_s(immediate); }

void rst_30(void) { rst_f(0x30); }

void ld_A_m_nn(unsigned short immediate) { ld_A_ss(immediate); }

void cp_n(unsigned char immediate) { cmp_s(immediate); }

void rst_38(void) { rst_f(0x38); }

const unsigned char baseOpcodeTicks[256] = {
    2, 6, 4,  4, 2,  2, 4, 4, 10, 4, 4,  4, 2,  2, 4, 4,  // 0x00 - 0x0F
    2, 6, 4,  4, 2,  2, 4, 4, 4,  4, 4,  4, 2,  2, 4, 4,  // 0x10 - 0x1F
    8, 6, 4,  4, 2,  2, 4, 2, 8,  4, 4,  4, 2,  2, 4, 2,  // 0x20 - 0x2F
    8, 6, 4,  4, 6,  6, 6, 2, 8,  4, 4,  4, 2,  2, 4, 2,  // 0x30 - 0x3F
    ...
    8, 6, 12, 6, 12, 8, 4, 8, 8,  2, 12, 0, 12, 6, 4, 8,  // 0xC0 - 0xCF
    8, 6, 12, 0, 12, 8, 4, 8, 8,  8, 12, 0, 12, 0, 4, 8,  // 0xD0 - 0xDF
