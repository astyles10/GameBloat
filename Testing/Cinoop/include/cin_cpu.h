...
#define FLAGS_ISZERO (cin_registers.f & FLAGS_ZERO)
#define FLAGS_ISNEGATIVE (cin_registers.f & FLAGS_NEGATIVE)
#define FLAGS_ISCARRY (cin_registers.f & FLAGS_CARRY)
#define FLAGS_ISHALFCARRY (cin_registers.f & FLAGS_HALFCARRY)

#define FLAGS_ISSET(x) (cin_registers.f & (x))
#define FLAGS_SET(x) (cin_registers.f |= (x))
#define FLAGS_CLEAR(x) (cin_registers.f &= ~(x))
...
extern unsigned char cin_stopped;
...
void rrca(void);
void cin_stop(unsigned char operand);
...
void cin_call_nn(unsigned short operand);
void adc_n(unsigned char operand);
void cin_rst_08(void);
void ret_nc(void);
void pop_de(void);
